...
#define GS_EXTRA_HOST_CREATE_TEST_MAGIC 0x504C325E
#define GS_EXTRA_WORKER_TEST_MAGIC      0x504C325F
#define GS_STORE_NTWK_TEST_MAGIC        0x504C3260
#define GS_STORE_WORKER_TEST_MAGIC      0x504C3261
